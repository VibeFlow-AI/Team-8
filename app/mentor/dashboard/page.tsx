...
export default function MentorDashboardPage() {
    ...
    setSessionRequests([
      {
        ...
        time: '14:00',
        duration: 60,
        description: 'I need help understanding neural networks and their applications.',
        status: 'pending'
      },
      {
        id: '2',
        ...
        time: '10:00',
        duration: 90,
        description: 'Help with implementing binary trees and graph algorithms.',
        status: 'pending'
      }
    ]);
  ...
  const handleRequestResponse = (requestId: string, action: 'approve' | 'reject') => {
    ...
    setStats(prev => ({
      ...
      upcomingSessions: action === 'approve' ? prev.upcomingSessions + 1 : prev.upcomingSessions
    }));
  };
    ...
    <div className="p-6">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">Manage your mentoring sessions and student requests</p>
        </div>
          ...
          <div className="space-y-6">
            ...
            {pendingRequests.length > 0 ? (
              ...
              <Card className="p-8 text-center">
                ...
                <p className="text-gray-600">You're all caught up! New session requests will appear here.</p>
              </Card>
            )}
          </div>
        )}
          ...
          <div className="space-y-6">
            ...
            {upcomingSessions.length > 0 ? (
              ...
              <Card className="p-8 text-center">
                ...
                <p className="text-gray-600">Your schedule is clear. Approved session requests will appear here.</p>
              </Card>
            )}
          </div>
        )}
